...
// character or a blank placeholder (such as an underscore), depending on whether or not the user has guessed the 
...
// a placeholder (like an underscore) if the letter has not been guessed
